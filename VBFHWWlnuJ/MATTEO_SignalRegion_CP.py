...
def run_log(Sample_Number_ll,Cut_Number_ll,C_Type_ll,Cut_Total_Number_ll,Significance_Table_ll,Input_Cfg_File_ll,Latex_File_ll,Summary_Output_File_ll,Directory_Path_ll,TTB_ScaleFactor_ll,ScaleW_ll):
    ...
    ScaleW_ll_str=str(ScaleW_ll);
    pdl3 = subprocess.Popen(['./bin/DataMCComparisonPlot.exe',Input_Cfg_File_ll[0],ScaleW_ll_str,"1",TTB_ScaleFactor_ll_str],stdout=subprocess.PIPE,stderr=output_log2)
    ev=0;
    #ev_ttb=0;
    #ev_counter=0;
    TTB_data=0;
...
if __name__ == '__main__':
    ...
    '''
    '''
    Scale_W_Factor_Dir_mm=ControlP_Dir_2+"/SignalRegion";
    ...
    for Cut_Number_mm in range(Cuts_Total_Number_mm):
        ...
        for n_sample in range(Sample_Total_Number_mm):
            ...
            if (Cuts_Total_Number_mm-1):
               ...
               Significance_Table_mm=run_log(n_sample,Cut_Number_mm,1,Cuts_Total_Number_mm,Significance_Table_mm,cfg_file_1,Output_Summary_Latex_File_mm,Output_Summary_File_mm,final_dir1,TTBar_Scale_Factor_mm,Scale_W_Factor_global)
               ...
               #def run_log(sampleNumber,cutNumber,ctype,total_cutNumber,Significance_Table_mm_log,input_cfg_file,latex_file,Output_Summary_File_mm,in_cc_dir):
               Significance_Table_mm=run_log(n_sample,Cut_Number_mm,2,Cuts_Total_Number_mm,Significance_Table_mm,cfg_file_2,Output_Summary_Latex_File_mm,Output_Summary_File_mm,final_dir2,TTBar_Scale_Factor_mm,Scale_W_Factor_global)
    ...
    for nsample in range(Sample_Total_Number_mm):
        ...
        efficence_result_string=["FINAL CONTROL PLOTS",
                                 ...
                                 " ",
                                 "Ended SignalRegion ControlPlots"];
